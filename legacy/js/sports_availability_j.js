...
var rsn_lookup = function(user_zipcode) {
    ...
    //$.getJSON( "http://agentanswercenterstg.directv.com/en-us/res/rover_tools/rsn/rsnzip.js" )

    // fills up state, rsn , xtra , choice , mlb , nba , nhl , sports_pack arrays with appropriate data from rsnzip.js data
    ...
    _.each(rsnzip, function(val, key) {
        ...
        // runs if zipcode comes in range format (ex. 90025-90100)
...
//Adjust RSN name to match dsse data
        ...
        _.each(gameData, function(val, key) {
            ...
            if(awayHome.indexOf(blackout) > -1 ){
                ...
                if(sport(val.League) === "Pro Hockey" && val.Broadcaster === "MSG" || val.Broadcaster === "MSG Plus" || val.Broadcaster === "MSG Alternate" || val.Broadcaster === "MSG Alternate 2"){
                    output += "<tr" + replayClassCheck(val.Replay) + "><td>" + moment(val.Event_Date, "MM-DD-YYY").format("MMM Do") + " - " + moment(val.Event_Time, "HH:mm").format("h:mmA") + "</td><td>" + sport(val.League) + "</td><td>" + val.Away + " @ " + val.Home + replayCheck(val.Replay) + "</td><td><strong>Ch " + channelCheck(val.Channel) + "</strong> - " + val.Broadcaster + "<span class='msg_pro_hockey'><img src='http://agentanswercenterstg.directv.com/en-us/res/system/img/warning-icon.png' /></span><br />" + minimumRequirement(val.Broadcaster) + "</td></tr>";
                }
                else
...
function blackoutChecker(zipcode, league, awayHome) {
    ...
    switch (league) {
        case "MLB":
            ...
            if (
                _.contains(dodgers, zipcode) &&
                (awayHome.indexOf("Dodgers") > -1)
            ) {
                blackout = "Dodgers";
            };
            break;
...
function Sport_packages_convertion(sport) {
    ...
    switch (sport) {
        case "MLBSFHD":
        case "MLB":
            strPkgName = "<a href='http://agentanswercenterstg.directv.com/en-us/res/programming/mlb_extra_innings.html' target='_blank'>MLB Extra Innings</a>";
            break;
        case "MLS":
        case "MLSHD":
            strPkgName = "<a href='http://agentanswercenterstg.directv.com/en-us/res/programming/mls_direct_kick.html' target='_blank'>MLS Direct Kick</a>";
            break;
        case "EPL":
            strPkgName = "<a href='http://agentanswercenterstg.directv.com/en-us/res/programming/directv_soccer.html?fragid=7' target='_blank'>DIRECTV Soccer</a>";
            break;
        case "CFBGP":
        case "CFBGP -IN WORK":
            strPkgName = "<a href='http://agentanswercenterstg.directv.com/en-us/res/programming/sports_pack.html' target='_blank'>Sports Pack</a>";
            break;
        //safa added start
        case "CBKHD":
        case "CBKHD -IN WORK":
        ...
        case "NHL":
        case "NHLHD":
            strPkgName = "<a href='http://agentanswercenterstg.directv.com/en-us/res/programming/nhl_center_ice.html' target='_blank'>NHL Center Ice</a>";
            break;
        case "NFL":
        case "NFLSFHD":
            strPkgName = "<a href='http://agentanswercenterstg.directv.com/en-us/res/sales_center/nflst_index.html' target='_blank'>NFL Sunday Ticket</a>";
            break;
        case "NBA":
        case "NBAHD":
            strPkgName = "<a href='http://agentanswercenterstg.directv.com/en-us/res/programming/nba_league_pass.html' target='_blank'>NBA League Pass</a>";
            break;
        case "RGBY":
            strPkgName = "<a href='http://agentanswercenterstg.directv.com/en-us/res/programming/directv_rugby.html' target='_blank'>DIRECTV Rugby</a>";
            break;
        case "CFBPPV":
            strPkgName = "<a href='http://agentanswercenterstg.directv.com/en-us/res/programming/ppv_college_football.html' target='_blank'>PPV College Football</a>";
            break;
        default:
            return sport;
    }
...
function minimumRequirement(rsn) {
    ...
    _.each(user.requiredPackage.choice, function(val, key) {
        if (rsn.indexOf(val) > -1) {
            min = "<p class='alert alert-info feed'><strong>Minimum Required Package: </strong><a href='http://agentanswercenterstg.directv.com/en-us/res/programming/choice.html' target='_blank'>Choice</a> / <a href='http://agentanswercenterstg.directv.com/en-us/res/programming/mas_ultra.html' target='_blank'>Mas Ultra</a></p>";
        };
    });

    _.each(user.requiredPackage.xtra, function(val, key) {
        if (rsn.indexOf(val) > -1) {
            min = "<p class='alert alert-info feed'><strong>Minimum Required Package: </strong><a href='http://agentanswercenterstg.directv.com/en-us/res/programming/choice_xtra_new.html' target='_blank'>Xtra</a></p>";
        };
    });
    ...
    switch (rsn){
        ...
        case "NBA TV":
            min = "<p class='alert alert-info feed'><strong>Minimum Required Package: </strong><a href='http://agentanswercenterstg.directv.com/en-us/res/programming/choice_xtra_new.html' target='_blank'>Xtra</a> / <a href='http://agentanswercenterstg.directv.com/en-us/res/programming/lo_maximo.html' target='_blank'>Lo Maximo</a></p>";
            break;
        case "NHL Network":
            min = "<p class='alert alert-info feed'><strong>Minimum Required Package: </strong><a href='http://agentanswercenterstg.directv.com/en-us/res/programming/choice_xtra_new.html' target='_blank'>Xtra</a></p>";
            break;
        case "NFL Network":
            ...
            break;
        case "NBC Sports":
            min = "<p class='alert alert-info feed'><strong>Minimum Required Package: </strong><a href='http://agentanswercenterstg.directv.com/en-us/res/programming/choice.html' target='_blank'>Choice</a> / <a href='http://agentanswercenterstg.directv.com/en-us/res/programming/lo_maximo.html' target='_blank'>Lo Maximo</a></p>";
            break;
        case "CFB":
        case "CFB -IN WORK":
            min = "<p class='alert alert-info feed'><strong>Required: </strong><a href='http://agentanswercenterstg.directv.com/en-us/res/programming/sports_pack.html' target='_blank'>Sports Pack</a></p>";
            break;
        // safa added start
        case "CBKHD":
        case "CBKHD -IN WORK":
